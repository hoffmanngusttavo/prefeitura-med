INSERT INTO prefeitura_api.ubs (id, nome, uuid, telefone, logradouro, bairro)
...
VALUES('Bacitracina', 'Santa', 1, 10, now(), '5f706abc-8a4c-4ff7-b7b6-ad55fa29229c', 1);

INSERT INTO prefeitura_api.medicamentos (nome, laboratorio, disponivel, miligramas, data_ultima_atualizacao, uuid, ubs_id)
VALUES('Baclofeno', 'Santa', 1, 10, now(), 'c9cbe021-463c-4e7f-af51-a367b478ff83', 1);

INSERT INTO prefeitura_api.medicamentos (nome, laboratorio, disponivel, miligramas, data_ultima_atualizacao, uuid, ubs_id)
VALUES('Betanecol', 'Santa', 1, 10, now(), '933b50d2-1287-42d2-b13a-17be1ddca504', 1);

INSERT INTO prefeitura_api.medicamentos (nome, laboratorio, disponivel, miligramas, data_ultima_atualizacao, uuid, ubs_id)
VALUES('Cantaridina', 'Santa', 1, 10, now(), 'ae054991-ca9f-4dbb-9708-c0d9a9d1690e', 1);


INSERT INTO prefeitura_api.medicamentos (nome, laboratorio, disponivel, miligramas, data_ultima_atualizacao, uuid, ubs_id)
VALUES('Bacitracina', 'Santa', 1, 10, now(), '5f706abc-8a4c-4ff7-b7b6-ad55fa29229e', 2);

INSERT INTO prefeitura_api.medicamentos (nome, laboratorio, disponivel, miligramas, data_ultima_atualizacao, uuid, ubs_id)
VALUES('Baclofeno', 'Santa', 1, 10, now(), 'c9cbe021-463c-4e7f-af51-a367b478ff81', 2);
